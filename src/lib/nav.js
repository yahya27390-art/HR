...
export const navigationModules = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/settings?tab=permissions', label: 'الصلاحيات والمجموعات', icon: ShieldCheck },
      { to: '/settings?tab=branches', label: 'إدارة الفروع', icon: Building },
      { to: '/settings?tab=departments', label: 'الأقسام والإدارات', icon: Layers },
      { to: '/settings?tab=bank_accounts', label: 'الحسابات المصرفية والأيبان', icon: Wallet },
      { to: '/settings?tab=salary_components', label: 'بنود الراتب والبدلات', icon: Calculator },
      { to: '/settings?tab=payroll_workflow', label: 'سير عمل الرواتب والاعتماد', icon: FileCheck },
      { to: '/settings?tab=request_workflows', label: 'سير عمل الطلبات', icon: GitBranch },
      { to: '/settings?tab=job_titles', label: 'المسميات الوظيفية', icon: Briefcase },
      { to: '/settings?tab=penalties', label: 'الجزاءات واللوائح', icon: AlertTriangle },
      { to: '/settings?tab=cadre_policies', label: 'إعدادات وسياسات الكادر', icon: Users },
      { to: '/settings?tab=document_templates', label: 'نماذج النظام وقوالب الطباعة', icon: FileText },
      ...
      { to: '/settings?tab=rewards_bonuses', label: 'أنواع المكافآت والتعويضات', icon: Award },
      { to: '/settings?tab=deductions_rules', label: 'الحسميات ونسب التأمينات', icon: Calculator },
      { to: '/settings?tab=advances_rules', label: 'السلف والقروض الشهرية', icon: CreditCard },
      { to: '/settings?tab=overtime_rules', label: 'العمل الإضافي وبدل الجمعات', icon: Clock },
      { to: '/settings?tab=geofencing', label: 'معرف لوكيشن والبصمة الذكية', icon: Fingerprint },
      { to: '/settings?tab=biometric_devices', label: 'أجهزة الحضور والشبكة', icon: UploadCloud },
      { to: '/settings?tab=custody_assets', label: 'العهد والأصول', icon: BookOpen },
      { to: '/settings?tab=medical_insurance', label: 'أنواع وسياسات التأمين', icon: CheckCircle2 },
      { to: '/settings?tab=audit_logs', label: 'سجلات وتدقيق النظام', icon: ClipboardList },
      { to: '/settings?tab=api_integration', label: 'الربط البرمجي (مدد • قوى)', icon: KeyRound },
    ]
  }
];
