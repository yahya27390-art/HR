...
export const SAUDI_INTERNAL_CONTRACT_TERMS = [
  {
    ...
    content: `يُبرم هذا العقد بين (الطرف الأول: درة السيارة لقطع غيار السيارات - سجل تجاري: 7016475555 - الرقم الضريبي: 311861381500003) ومقرها المملكة العربية السعودية، وبين (الطرف الثاني: الموظف الموضح بياناته أعلاه). ويعتبر التمهيد والبيانات الوظيفية جزءاً لا يتجزأ من هذا العقد.`
  },
  {
  ...
  },
  {
    ...
    content: `يخضع الموظف لفترة تجربة مدتها (90) يوماً تبدأ من تاريخ مباشرته للعمل، ويحق لأي من الطرفين إنهاء العقد خلال هذه الفترة وفقاً لأحكام نظام العمل السعودي ولائحة تنظيم العمل بالمنشأة.`
  },
  {
...
1) يترتب عليه جزاء فوري بخصم أجر شهر الإشعار بالكامل من مستحقاته ونهائية خدمته.
2) في حال ترتب أضرار تشغيلية على المنشأة، يُلزم الموظف بتعويض المؤسسة بمبلغ يعادل (راتب شهرين كاملين) من آخر راتب شهري تقاضاه، تعويضاً عن الإخلال بالالتزام العقدي وفق أحكام النظام ولائحة المنشأة.`
  },
  {
    article: 'المادة التاسعة: السرية وحماية ممتلكات المنشأة وعدم المنافسة',
    title: 'الالتزام بالأمانة والسرية المهنية',
    content: `يتعهد الطرف الثاني بالمحافظة التامة على سرية أعمال المنشأة، بيانات العملاء، الأسعار، والحسابات، وعدم إفشاء أي معلومات سرية سواء أثناء سريان العقد أو بعد انتهائه، كما يتعهد بعدم منافسة المنشأة بصورة مباشرة أو غير مباشرة.`
  },
  {
