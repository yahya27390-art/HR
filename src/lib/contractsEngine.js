...
2) في حال ترتب أضرار تشغيلية على المنشأة، يُلزم الموظف بتعويض الشركة بمبلغ يعادل (راتب شهرين كاملين) من آخر راتب شهري تقاضاه، تعويضاً عن الإخلال بالالتزام العقدي وفق أحكام النظام ولائحة المنشأة.`
  },
  {
